...
Analyze retail transaction data to understand customer behavior

Segment customers using RFM analysis

Identify churn-risk customers for retention strategies
...
Analytics: RFM Analysis, Association Rule Mining (Apriori)
...
SQL scripts for data preparation and modeling

Python ETL scripts for analytics processing

RFM customer segmentation output

Association rules dataset for product bundling
